...
import CourseBar from '../components/core/Course/CourseBar';
...
const CourseDetails = () => {
    ...
    const response = courseData?.data?.courseDetails;
  ...
  return (
    <>
          ...
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            >
              ...
              <div className="text-md flex flex-wrap items-center gap-2">
                ...
                <span>{`${studentsEndrolled.length} students enrolled`}</span>
              </div>
              <div>
                <p className="">
      ...
      <div className='box-content text-richblack-5 px-4 mx-auto text-start lg:w-[1260px]'>
        <div className='mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]'>
          ...
          <div className='py-4'>
            {
              courseContent?.map((sec_name,index) => (
                <CourseBar
                  key={index}
                  secName={sec_name}
                  isActive={isActive}
