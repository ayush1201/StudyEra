...
Study Era is an ED Tech (Education Technology) web application developed using the MERN stack.
...
3. Set up the environment variables:
   ...
   Add the required environment variables, such as database connection details, JWT secret, and any other necessary configurations check .env files for more info.
